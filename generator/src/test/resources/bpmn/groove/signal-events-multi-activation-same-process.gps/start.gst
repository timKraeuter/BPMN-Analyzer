...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="signal-events-multi-activation-same-process_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"start_p1_S1_Throw_Flow_09vy9fu"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
