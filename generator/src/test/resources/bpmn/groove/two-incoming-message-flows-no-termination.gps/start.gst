...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="two-incoming-message-flows-no-termination_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"start_p2_Catch_2"</string>
            </attr>
        </edge>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>string:"start_p3_end_p3"</string>
            </attr>
        </edge>
        <node id="n10">
            <attr name="layout">
        ...
        <edge from="n14" to="n14">
            <attr name="label">
                <string>string:"start_p1_end_p1"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
