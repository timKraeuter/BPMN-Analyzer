...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="link-event_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"start_p1 -&gt; p1_pg1 (Flow_1fl0c6v)"</string>
            </attr>
        </edge>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>string:"start_p2 -&gt; p2_pg1 (Flow_1pptdul)"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
