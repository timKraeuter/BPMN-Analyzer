...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="ecmfa_usecase" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"controller_started -&gt; e1 (ID_66)"</string>
            </attr>
        </edge>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>string:"Approaching_Junction_B -&gt; Request_TL_status_B (ID_78)"</string>
            </attr>
        </edge>
        <node id="n10">
            <attr name="layout">
        ...
        <edge from="n14" to="n14">
            <attr name="label">
                <string>string:"Approaching_Junction_A -&gt; Request_TL_status_A (ID_88)"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
