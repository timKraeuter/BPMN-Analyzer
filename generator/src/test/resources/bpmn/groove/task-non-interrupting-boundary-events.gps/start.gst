...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="task-non-interrupting-boundary-events_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n1" to="n1">
            <attr name="label">
                <string>string:"Activity boundary events"</string>
            </attr>
        </edge>
        <node id="n2">
            <attr name="layout">
        ...
        <node id="n4">
            <attr name="layout">
                <string>907 472 0 0</string>
            </attr>
        </node>
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"Activity boundary events_start"</string>
            </attr>
        </edge>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>string:"interruptTrigger_start_trigger"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
