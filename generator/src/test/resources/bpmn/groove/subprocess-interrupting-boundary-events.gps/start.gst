...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="subprocess-interrupting-boundary-events" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"start -&gt; Subprocess1 (Flow_114zxb5)"</string>
            </attr>
        </edge>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>string:"start_trigger -&gt; interruptMessage (Flow_0u2o9mg)"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
