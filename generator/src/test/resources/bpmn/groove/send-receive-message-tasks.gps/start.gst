...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="send-receive-message-tasks_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"start_p1_TSend_1_Flow_1kebatm"</string>
            </attr>
        </edge>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>string:"start_p2_TReceive_1_Flow_0ryj8bj"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
