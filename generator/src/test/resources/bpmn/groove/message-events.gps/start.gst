...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="message-events_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"start_p1 -&gt; catch_A (Flow_12mxyv6)"</string>
            </attr>
        </edge>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>string:"start_p2 -&gt; throw_A (Flow_1sb90yn)"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
