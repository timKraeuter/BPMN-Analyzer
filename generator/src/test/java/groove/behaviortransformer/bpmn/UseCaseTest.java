...
class UseCaseTest extends BPMNToGrooveTestBase {
  ...
  /**
   * See test case <a href="https://cawemo.com/share/3da1f1ce-a0ca-4fa5-8caf-8bd04b879879">"Use Case
   * Test"</a> in cawemo.
   */
  @Test
  void testUseCase() throws IOException {
    ...
    IntermediateCatchEvent tl_status_requested1 =
        new IntermediateCatchEvent(
            getId(), "TL_status_requested1", IntermediateCatchEventType.MESSAGE);
    IntermediateThrowEvent a_c_green_t =
        new IntermediateThrowEvent(getId(), "A_C_green_t", IntermediateThrowEventType.MESSAGE);
    IntermediateCatchEvent b_green_requested =
        new IntermediateCatchEvent(
            getId(), "B_green_requested", IntermediateCatchEventType.MESSAGE);
    EndEvent phase1_end = new EndEvent(getId(), "Phase1_end");

    String phase_1 = "Phase_1";
    BPMNProcess phase1_process =
        new BPMNCollaborationBuilder()
            .name(phase_1)
            .processName(phase_1)
    ...
    IntermediateCatchEvent tl_status_requested2 =
        new IntermediateCatchEvent(
            getId(), "TL_status_requested2", IntermediateCatchEventType.MESSAGE);
    IntermediateThrowEvent b_green_t =
        new IntermediateThrowEvent(getId(), "B_green_t", IntermediateThrowEventType.MESSAGE);
    IntermediateCatchEvent a_c_green_requested =
        new IntermediateCatchEvent(
            getId(), "A_C_green_requested", IntermediateCatchEventType.MESSAGE);
    EndEvent phase2_end = new EndEvent(getId(), "Phase2_end");

    String phase_2 = "Phase_2";
    BPMNProcess phase2_Process =
        new BPMNCollaborationBuilder()
            .name(phase_2)
            .processName(phase_2)
    ...
    BoundaryEvent phase_1_over =
        new BoundaryEvent(getId(), "Phase_1_over", BoundaryEventType.TIMER, true);
    phase1.attachBoundaryEvent(phase_1_over);
    Task switch_to_p2 = new Task(getId(), "Switch_to_P2");
    IntermediateThrowEvent b_green_signal =
        new IntermediateThrowEvent(
            getId(), "B_is_green_t", IntermediateThrowEventType.SIGNAL, b_is_green);

    CallActivity phase2 = new CallActivity(getId(), phase2_Process);
    BoundaryEvent phase_2_over =
        new BoundaryEvent(getId(), "Phase_2_over", BoundaryEventType.TIMER, true);
    phase2.attachBoundaryEvent(phase_2_over);
    Task switch_to_p1 = new Task(getId(), "Switch_to_P1");
    IntermediateThrowEvent ac_green_signal =
        new IntermediateThrowEvent(
            getId(), "A_C_are_green_t", IntermediateThrowEventType.SIGNAL, a_c_are_green);
    ...
    IntermediateCatchEvent b_is_red_r =
        new IntermediateCatchEvent(getId(), "B_is_red", IntermediateCatchEventType.MESSAGE);
    SendTask request_green_tl_B = new SendTask(getId(), "Request_green_tl_B");
    IntermediateCatchEvent b_is_green_signal =
        new IntermediateCatchEvent(
            getId(), "B_is_green_signal", IntermediateCatchEventType.SIGNAL, b_is_green);
    ExclusiveGateway e3_B = new ExclusiveGateway(getId(), "e3_B");
    Task pass_junction_B = new Task(getId(), "Pass_Junction_B");
    IntermediateCatchEvent b_is_green_r =
        new IntermediateCatchEvent(getId(), "B_is_green_r", IntermediateCatchEventType.MESSAGE);
    ...
    IntermediateCatchEvent a_is_red_r =
        new IntermediateCatchEvent(getId(), "A_is_red", IntermediateCatchEventType.MESSAGE);
    SendTask request_green_tl_A = new SendTask(getId(), "Request_green_tl_A");
    IntermediateCatchEvent a_is_green_signal =
        new IntermediateCatchEvent(
            getId(), "A_is_green_signal", IntermediateCatchEventType.SIGNAL, b_is_green);
    ExclusiveGateway e3_A = new ExclusiveGateway(getId(), "e3_A");
    Task pass_junction_A = new Task(getId(), "Pass_Junction_A");
    IntermediateCatchEvent a_is_green_r =
        new IntermediateCatchEvent(getId(), "A_is_green_r", IntermediateCatchEventType.MESSAGE);
