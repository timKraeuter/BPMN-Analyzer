...
@XmlType(
    name = "",
    propOrder = {"attr", "locatorOrBoolOrIntOrFloatOrStringOrEnumOrSeqOrSetOrBagOrTup"})
...
public class Attr {
   ...
   * locatorOrBoolOrIntOrFloatOrStringOrEnumOrSeqOrSetOrBagOrTup property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * {@link Int } {@link Float } {@link groove.gxl.String } {@link Enum } {@link Seq } {@link Set }
   * {@link Bag } {@link Tup }
   */
