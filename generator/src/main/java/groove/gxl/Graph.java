...
@XmlType(
    name = "",
    propOrder = {"type", "attr", "nodeOrEdgeOrRel"})
...
public class Graph {
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the nodeOrEdgeOrRel property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Node } {@link Edge } {@link
   * Rel }
   */
  public List<Object> getNodeOrEdgeOrRel() {
    if (nodeOrEdgeOrRel == null) {
      nodeOrEdgeOrRel = new ArrayList<>();
    }
