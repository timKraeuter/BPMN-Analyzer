...
@XmlType(
    name = "",
    propOrder = {"type", "attr", "graph", "relend"})
...
public class Rel {
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the relend property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Relend }
   */
  public List<Relend> getRelend() {
    if (relend == null) {
      relend = new ArrayList<>();
    }
    return this.relend;
  }
}
