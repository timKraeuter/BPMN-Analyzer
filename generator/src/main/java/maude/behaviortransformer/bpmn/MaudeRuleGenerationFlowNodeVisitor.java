...
public class MaudeRuleGenerationFlowNodeVisitor implements FlowNodeVisitor {
  ...
  public MaudeRuleGenerationFlowNodeVisitor(
      BPMNMaudeRuleGenerator generator, AbstractBPMNProcess process) {
  ...
  public void handle(EventBasedGateway eventBasedGateway) {
    generator.getGatewayRuleGenerator().createEventBasedGatewayRule(process, eventBasedGateway);
  }
