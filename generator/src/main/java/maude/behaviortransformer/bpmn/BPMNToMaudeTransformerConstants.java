...
public final class BPMNToMaudeTransformerConstants {
  ...
  public static final String TOKEN_FORMAT =
      "\"%s (%s)\""; // Name of the FlowElement followed by id.
  public static final String SIGNAL_OCCURRENCE_FORMAT = "\"%s (%s)_signal\"";
  public static final String TOKEN_FORMAT_ONLY_ID =
      "\"%s\""; // Name of the FlowElement followed by id.
  public static final String SIGNAL_OCCURRENCE_FORMAT_ONLY_ID =
      "\"%s_signal\""; // Name of the FlowElement followed by id.
