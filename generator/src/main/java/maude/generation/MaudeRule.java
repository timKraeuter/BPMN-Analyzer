...
public class MaudeRule {
    ...
    private static final String CRULE_TEMPLATE = "crl [${name}] :  ${preObjects} => ${postObjects} if ${condition} .";
    ...
    public MaudeRule(String name, Set<MaudeObject> preObjects, Set<MaudeObject> postObjects, String condition) {
        this.name = name;
