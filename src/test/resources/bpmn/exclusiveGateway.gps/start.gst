...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="exclusiveGateway_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n1" to="n1">
            <attr name="label">
                <string>string:"exclusiveGateway"</string>
            </attr>
        </edge>
        <node id="n2">
            <attr name="layout">
        ...
        <edge from="n4" to="n4">
            <attr name="label">
                <string>string:"exclusiveGateway_start"</string>
            </attr>
        </edge>
        <edge from="n0" to="n1">
            <attr name="label">
