...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="Decision_start" role="rule" edgeids="false" edgemode="directed">
        <node id="n0">
            <attr name="layout">
                <string>482 792 0 0</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
